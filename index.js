...
let numberDedicator=Math.ceil(Math.random()*messages.length)
...
function clicked(){
    let numberDedicator=randomNumber()
    
    document.querySelector("#message").innerHTML=messageSelector(numberDedicator)
}
